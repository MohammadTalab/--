...
<head>
    ...
    <title>🛍️ المنتجات - متجر خير بلادك</title>
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="products.php" class="active">🛍️ المنتجات</a></li>
    ...
    <main>
        <div class="products-section">
            <h2>🛍️ جميع المنتجات المتوفرة</h2>
                    ...
                    <?php foreach($products as $product): ?>
                        <div class="product-card" data-product-id="<?php echo $product['p_id']; ?>">
                            ...
                            <?php if (isset($product['category_name'])): ?>
                                <p style="color: var(--secondary-color); font-size: 12px; margin-bottom: 10px; font-weight: 600;">🏷️ <?php echo htmlspecialchars($product['category_name']); ?></p>
                            <?php endif; ?>
